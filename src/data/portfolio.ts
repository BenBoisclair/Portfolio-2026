...
export const stats: Stat[] = [
  ...
  { value: "2 mo.", label: "idea → production" },
];

const tastemapScreens: Screen[] = [
  { src: "/media/tastemap/01-splash.webp", caption: "Splash", alt: "TasteMap splash screen with the brand mark", w: 780, h: 1688 },
  { src: "/media/tastemap/02-home.webp", caption: "Home feed", alt: "TasteMap home feed showing featured markets and categories", w: 780, h: 4604 },
  { src: "/media/tastemap/03-discovery.webp", caption: "Discover", alt: "Recommended-for-you list of vendors", w: 390, h: 1200 },
  { src: "/media/tastemap/04-market-highlights.webp", caption: "Market · Highlights", alt: "Market page highlights tab with unique services and ratings", w: 390, h: 1822 },
  { src: "/media/tastemap/05-market-info.webp", caption: "Market · Info", alt: "Market page map and info tab with hours, map and history", w: 390, h: 2067 },
  { src: "/media/tastemap/06-market-review.webp", caption: "Market · Reviews", alt: "Market page reviews tab with a multi-axis rating breakdown", w: 390, h: 1061 },
  { src: "/media/tastemap/07-vendor-info.webp", caption: "Vendor · Promotion", alt: "Vendor page showing a buy-two-get-one promotion", w: 390, h: 1285 },
  { src: "/media/tastemap/08-redeem-quantity.webp", caption: "Redeem · Quantity", alt: "Promotion redemption screen selecting quantities", w: 390, h: 1043 },
  { src: "/media/tastemap/09-redeem-qr.webp", caption: "Redeem · QR", alt: "QR code shown to the merchant to redeem a promotion", w: 390, h: 948 },
];

const rubieScreens: Screen[] = [
  { src: "/media/rubie/01-home.webp", caption: "Wallet", alt: "Rubie Wallet home with THBX and USDC balances and recent transactions", w: 513, h: 1110 },
  { src: "/media/rubie/02-explore.webp", caption: "Explore", alt: "Rubie Wallet explore tab with merchant discovery and promotions", w: 513, h: 1111 },
];

const eventlinkPhotos: Photo[] = [
  { thumb: "/media/eventlink/01-award-check-thumb.webp", full: "/media/eventlink/01-award-check-full.webp", caption: "2nd place · TED Youth Startup Championship 2025", alt: "The EventLink team on stage receiving the 2nd runner-up award cheque", w: 1600, h: 900 },
  { thumb: "/media/eventlink/02-team-trophy-thumb.webp", full: "/media/eventlink/02-team-trophy-full.webp", caption: "The team with the championship trophy", alt: "The EventLink team holding the trophy beside an EventLink poster", w: 1200, h: 1600 },
  { thumb: "/media/eventlink/03-pitching-thumb.webp", full: "/media/eventlink/03-pitching-full.webp", caption: "Pitching EventLink on stage", alt: "Benedict pitching EventLink on stage with a microphone", w: 1600, h: 900 },
  { thumb: "/media/eventlink/04-booth-demo-thumb.webp", full: "/media/eventlink/04-booth-demo-full.webp", caption: "Demoing EventLink at the booth", alt: "Benedict demoing EventLink to a visitor at the expo booth", w: 1108, h: 1477 },
  { thumb: "/media/eventlink/05-booth-busan-thumb.webp", full: "/media/eventlink/05-booth-busan-full.webp", caption: "At the FLYAsia Busan 2025 expo", alt: "The EventLink booth at the FLYAsia Busan 2025 expo", w: 1108, h: 1477 },
  { thumb: "/media/eventlink/06-booth-crowd-thumb.webp", full: "/media/eventlink/06-booth-crowd-full.webp", caption: "The EventLink booth · FLYAsia Busan", alt: "Visitors at the EventLink expo booth", w: 1108, h: 1477 },
  { thumb: "/media/eventlink/07-booth-team-thumb.webp", full: "/media/eventlink/07-booth-team-full.webp", caption: "At the TED Youth Startup Championship", alt: "The EventLink team at the TED Youth Startup Championship booth", w: 1108, h: 1477 },
  { thumb: "/media/eventlink/08-award-stage-thumb.webp", full: "/media/eventlink/08-award-stage-full.webp", caption: "Receiving the ฿1.5M fast-track award", alt: "The award ceremony on stage with the fast-track grant cheque", w: 1284, h: 1271 },
  { thumb: "/media/eventlink/09-pitching-duo-thumb.webp", full: "/media/eventlink/09-pitching-duo-full.webp", caption: "On the pitching stage", alt: "Benedict and his co-founder presenting EventLink on the pitching stage", w: 1284, h: 1264 },
];
...
export const featured: Project[] = [
  {
    ...
    bullets: [
      "I took EventLink from an empty repo to a live product with real users in under two months, leading a small team and owning the whole roadmap.",
      ...
      "I also built the AI features (streaming task generation and an in-app assistant on Claude with RAG) and shipped it bilingually across AWS, DigitalOcean, and Cloudflare. It's backed by a ฿1.5M TED Fund grant.",
    ],
  ...
  },
  {
    ...
    press: [
      {
        source: "Chulalongkorn CSII",
        title: "A Student-Led AI Gateway Between Tourists and Thai Micro-Vendors",
